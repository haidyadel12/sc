...
import 'package:final_ed/Authtentication/login.dart';
import 'package:final_ed/JsonModels/users.dart';
import 'package:final_ed/SQLite/sqlite.dart';
                ...
                children: [
                  ...
                  const ListTile(
                    title: Text(
                      "Create New Account",
                      style:
                      TextStyle(fontSize: 35, fontWeight: FontWeight.bold , color: Color(0xffff6c22),),
                    ),
                  ),
                        ...
                        onPressed: () {
                          if (formKey.currentState!.validate()) {
                            ...
                            db
                                ...
                                usrPassword: password.text, usrEmail: useremail.text))
                                .whenComplete(() {
